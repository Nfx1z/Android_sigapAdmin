...
describe('v2beta2.CloudTasksClient', () => {
    ...
    describe('getQueue', () => {
        it('invokes getQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.GetQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.GetQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
    ...
    describe('createQueue', () => {
        it('invokes createQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.CreateQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.CreateQueueRequest', ['parent']);
    ...
    describe('updateQueue', () => {
        it('invokes updateQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.UpdateQueueRequest());
            request.queue ??= {};
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.UpdateQueueRequest', ['queue', 'name']);
    ...
    describe('deleteQueue', () => {
        it('invokes deleteQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.DeleteQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.DeleteQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
    ...
    describe('purgeQueue', () => {
        it('invokes purgeQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.PurgeQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.PurgeQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
    ...
    describe('pauseQueue', () => {
        it('invokes pauseQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.PauseQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.PauseQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
    ...
    describe('resumeQueue', () => {
        it('invokes resumeQueue without error', async () => {
            ...
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.ResumeQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
    ...
    describe('uploadQueueYaml', () => {
        it('invokes uploadQueueYaml without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.UploadQueueYamlRequest());
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
        ...
        it('invokes uploadQueueYaml without error using callback', async () => {
            ...
            client.innerApiCalls.uploadQueueYaml =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.uploadQueueYaml(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.GetTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.GetTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
    ...
    describe('createTask', () => {
        it('invokes createTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.CreateTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.CreateTaskRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
    ...
    describe('deleteTask', () => {
        it('invokes deleteTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.DeleteTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.DeleteTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
    ...
    describe('leaseTasks', () => {
        it('invokes leaseTasks without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.LeaseTasksRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.LeaseTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.LeaseTasksResponse());
            client.innerApiCalls.leaseTasks = stubSimpleCall(expectedResponse);
            const [response] = await client.leaseTasks(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.leaseTasks.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.leaseTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes leaseTasks without error using callback', async () => {
            ...
            client.innerApiCalls.leaseTasks =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.leaseTasks(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('acknowledgeTask', () => {
        it('invokes acknowledgeTask without error', async () => {
            ...
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.AcknowledgeTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.acknowledgeTask.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.acknowledgeTask.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes acknowledgeTask without error using callback', async () => {
            ...
            client.innerApiCalls.acknowledgeTask =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.acknowledgeTask(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('renewLease', () => {
        it('invokes renewLease without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.RenewLeaseRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.RenewLeaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.renewLease.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.renewLease.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes renewLease without error using callback', async () => {
            ...
            client.innerApiCalls.renewLease =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.renewLease(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('cancelLease', () => {
        it('invokes cancelLease without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.CancelLeaseRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.CancelLeaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.cancelLease.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.cancelLease.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes cancelLease without error using callback', async () => {
            ...
            client.innerApiCalls.cancelLease =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.cancelLease(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('runTask', () => {
        it('invokes runTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.RunTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.RunTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
    ...
    describe('listQueues', () => {
        it('invokes listQueues without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.ListQueuesRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.ListQueuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
    ...
    describe('listTasks', () => {
        it('invokes listTasks without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.ListTasksRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.ListTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            const expectedResponse = [
