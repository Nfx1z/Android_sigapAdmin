...
describe('v2beta3.CloudTasksClient', () => {
    ...
    describe('getQueue', () => {
        it('invokes getQueue without error', async () => {
            ...
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.GetQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.Queue());
            client.innerApiCalls.getQueue = stubSimpleCall(expectedResponse);
            const [response] = await client.getQueue(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.getQueue.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.getQueue.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    describe('createQueue', () => {
        it('invokes createQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.CreateQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.CreateQueueRequest', ['parent']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.createQueue.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.createQueue.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('updateQueue', () => {
        it('invokes updateQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.UpdateQueueRequest());
            request.queue ??= {};
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.UpdateQueueRequest', ['queue', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.updateQueue.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.updateQueue.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('deleteQueue', () => {
        it('invokes deleteQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.DeleteQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.DeleteQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.deleteQueue.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.deleteQueue.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('purgeQueue', () => {
        it('invokes purgeQueue without error', async () => {
            ...
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.PurgeQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.Queue());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.purgeQueue.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.purgeQueue.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('pauseQueue', () => {
        it('invokes pauseQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.PauseQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.PauseQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.Queue());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.pauseQueue.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.pauseQueue.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('resumeQueue', () => {
        it('invokes resumeQueue without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.ResumeQueueRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.ResumeQueueRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.Queue());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.resumeQueue.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.resumeQueue.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
    ...
    describe('getTask', () => {
        it('invokes getTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.GetTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.GetTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.Task());
            client.innerApiCalls.getTask = stubSimpleCall(expectedResponse);
            const [response] = await client.getTask(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.getTask.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.getTask.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes getTask without error using callback', async () => {
            ...
            client.innerApiCalls.getTask =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.getTask(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('createTask', () => {
        it('invokes createTask without error', async () => {
            ...
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.CreateTaskRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.Task());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.createTask.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.createTask.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes createTask without error using callback', async () => {
            ...
            client.innerApiCalls.createTask =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.createTask(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('deleteTask', () => {
        it('invokes deleteTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.DeleteTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.DeleteTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.deleteTask.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.deleteTask.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes deleteTask without error using callback', async () => {
            ...
            client.innerApiCalls.deleteTask =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.deleteTask(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('runTask', () => {
        it('invokes runTask without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.RunTaskRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.RunTaskRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.Task());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.runTask.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.runTask.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes runTask without error using callback', async () => {
            ...
            client.innerApiCalls.runTask =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.runTask(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('updateCmekConfig', () => {
        it('invokes updateCmekConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest());
            request.cmekConfig ??= {};
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest', ['cmekConfig', 'name']);
            request.cmekConfig.name = defaultValue1;
            const expectedHeaderRequestParams = `cmek_config.name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.CmekConfig());
            client.innerApiCalls.updateCmekConfig = stubSimpleCall(expectedResponse);
            const [response] = await client.updateCmekConfig(request);
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.updateCmekConfig.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.updateCmekConfig.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes updateCmekConfig without error using callback', async () => {
            ...
            client.innerApiCalls.updateCmekConfig =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.updateCmekConfig(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        it('invokes updateCmekConfig with error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        it('invokes updateCmekConfig with closed client', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    describe('getCmekConfig', () => {
        it('invokes getCmekConfig without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.GetCmekConfigRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.GetCmekConfigRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.CmekConfig());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.getCmekConfig.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.getCmekConfig.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes getCmekConfig without error using callback', async () => {
            ...
            client.innerApiCalls.getCmekConfig =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.getCmekConfig(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    describe('batchCreateTasks', () => {
        it('invokes batchCreateTasks without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.BatchCreateTasksRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.BatchCreateTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.batchCreateTasks =
                stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchCreateTasks(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.batchCreateTasks.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.batchCreateTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes batchCreateTasks without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                client.batchCreateTasks(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        it('invokes batchCreateTasks with call error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        it('invokes batchCreateTasks with LRO error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        it('invokes checkBatchCreateTasksProgress without error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const decodedOperation = await client.checkBatchCreateTasksProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert(client.operationsClient.getOperation.getCall(0));
        });
        it('invokes checkBatchCreateTasksProgress with error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            await assert.rejects(client.checkBatchCreateTasksProgress(''), expectedError);
            assert(client.operationsClient.getOperation.getCall(0));
        });
    });
    describe('batchDeleteTasks', () => {
        it('invokes batchDeleteTasks without error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.BatchDeleteTasksRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.BatchDeleteTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.batchDeleteTasks =
                stubLongRunningCall(expectedResponse);
            const [operation] = await client.batchDeleteTasks(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.batchDeleteTasks.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.batchDeleteTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes batchDeleteTasks without error using callback', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.batchDeleteTasks =
                stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.batchDeleteTasks(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        it('invokes batchDeleteTasks with call error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            await assert.rejects(client.batchDeleteTasks(request), expectedError);
            const actualRequest = client.innerApiCalls.batchDeleteTasks.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.batchDeleteTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes batchDeleteTasks with LRO error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        it('invokes checkBatchDeleteTasksProgress without error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            expectedResponse.metadata = { type_url: 'url', value: Buffer.from('') };
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkBatchDeleteTasksProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert(client.operationsClient.getOperation.getCall(0));
        });
        it('invokes checkBatchDeleteTasksProgress with error', async () => {
            const client = new cloudtasksModule.v2beta3.CloudTasksClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const expectedError = new Error('expected');
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkBatchDeleteTasksProgress(''), expectedError);
            assert(client.operationsClient.getOperation.getCall(0));
        });
    });
    describe('listQueues', () => {
        it('invokes listQueues without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.ListQueuesRequest());
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.ListQueuesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.listQueues.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.listQueues.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes listQueues without error using callback', async () => {
            ...
            client.innerApiCalls.listQueues =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.listQueues(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        it('invokes listQueuesStream without error', async () => {
            ...
            assert(client.descriptors.page.listQueues.createStream
                .getCall(0)
        ...
        it('uses async iteration with listQueues without error', async () => {
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(client.descriptors.page.listQueues.asyncIterate.getCall(0).args[1], request);
            assert(client.descriptors.page.listQueues.asyncIterate
                .getCall(0)
                .args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
        });
    ...
    describe('listTasks', () => {
        it('invokes listTasks without error', async () => {
            ...
            const defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.ListTasksRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1 ?? ''}`;
            const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.listTasks.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.listTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        it('invokes listTasks without error using callback', async () => {
            ...
            client.innerApiCalls.listTasks =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.listTasks(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        it('invokes listTasksStream without error', async () => {
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert(client.descriptors.page.listTasks.createStream
                .getCall(0)
        ...
        it('uses async iteration with listTasks without error', async () => {
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(client.descriptors.page.listTasks.asyncIterate.getCall(0)
                .args[1], request);
            assert(client.descriptors.page.listTasks.asyncIterate
                .getCall(0)
                .args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
        });
    ...
    describe('getLocation', () => {
        it('invokes getLocation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new LocationProtos.google.cloud.location.GetLocationRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new LocationProtos.google.cloud.location.Location());
    ...
    describe('listLocationsAsync', () => {
        it('uses async iteration with listLocations without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new LocationProtos.google.cloud.location.ListLocationsRequest());
            request.name = '';
            const expectedHeaderRequestParams = 'name=';
            const expectedResponse = [
    ...
    describe('getOperation', () => {
        it('invokes getOperation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new operationsProtos.google.longrunning.GetOperationRequest());
            const expectedResponse = generateSampleMessage(new operationsProtos.google.longrunning.Operation());
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
    ...
    describe('cancelOperation', () => {
        it('invokes cancelOperation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new operationsProtos.google.longrunning.CancelOperationRequest());
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
    ...
    describe('deleteOperation', () => {
        it('invokes deleteOperation without error', async () => {
            ...
            await client.initialize();
            const request = generateSampleMessage(new operationsProtos.google.longrunning.DeleteOperationRequest());
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
    ...
    describe('listOperationsAsync', () => {
        it('uses async iteration with listOperations without error', async () => {
            ...
            const request = generateSampleMessage(new operationsProtos.google.longrunning.ListOperationsRequest());
            const expectedResponse = [
                generateSampleMessage(new operationsProtos.google.longrunning.ListOperationsResponse()),
                generateSampleMessage(new operationsProtos.google.longrunning.ListOperationsResponse()),
                generateSampleMessage(new operationsProtos.google.longrunning.ListOperationsResponse()),
            ];
    ...
    describe('Path templates', () => {
        describe('cmekConfig', () => {
            const fakePath = '/rendered/path/cmekConfig';
            ...
            client.pathTemplates.cmekConfigPathTemplate.render = sinon
                .stub()
                .returns(fakePath);
            client.pathTemplates.cmekConfigPathTemplate.match = sinon
                .stub()
                .returns(expectedParameters);
            it('cmekConfigPath', () => {
                const result = client.cmekConfigPath('projectValue', 'locationValue');
                assert.strictEqual(result, fakePath);
                assert(client.pathTemplates.cmekConfigPathTemplate.render
                    .getCall(-1)
                    .calledWith(expectedParameters));
            });
            it('matchProjectFromCmekConfigName', () => {
                const result = client.matchProjectFromCmekConfigName(fakePath);
                assert.strictEqual(result, 'projectValue');
                assert(client.pathTemplates.cmekConfigPathTemplate.match
                    .getCall(-1)
                    .calledWith(fakePath));
            });
            it('matchLocationFromCmekConfigName', () => {
                const result = client.matchLocationFromCmekConfigName(fakePath);
        ...
        describe('queue', () => {
            ...
            client.pathTemplates.queuePathTemplate.match = sinon
                ...
                .returns(expectedParameters);
            it('queuePath', () => {
                const result = client.queuePath('projectValue', 'locationValue', 'queueValue');
                assert.strictEqual(result, fakePath);
                assert(client.pathTemplates.queuePathTemplate.render
                    .getCall(-1)
                    .calledWith(expectedParameters));
            });
            it('matchProjectFromQueueName', () => {
                ...
                assert.strictEqual(result, 'projectValue');
                assert(client.pathTemplates.queuePathTemplate.match
                    .getCall(-1)
                    .calledWith(fakePath));
            });
        ...
        describe('task', () => {
            ...
            client.pathTemplates.taskPathTemplate.match = sinon
                ...
                .returns(expectedParameters);
            it('taskPath', () => {
                const result = client.taskPath('projectValue', 'locationValue', 'queueValue', 'taskValue');
                assert.strictEqual(result, fakePath);
                assert(client.pathTemplates.taskPathTemplate.render
                    .getCall(-1)
                    .calledWith(expectedParameters));
            });
            it('matchProjectFromTaskName', () => {
                ...
                assert.strictEqual(result, 'projectValue');
                assert(client.pathTemplates.taskPathTemplate.match
                    .getCall(-1)
                    .calledWith(fakePath));
            });
