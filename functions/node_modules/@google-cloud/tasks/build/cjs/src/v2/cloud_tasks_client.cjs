...
var CloudTasksClient = exports.CloudTasksClient = /*#__PURE__*/function () {
  ...
  function CloudTasksClient(opts, gaxInstance) {
    ...
    this._defaults = this._gaxGrpc.constructSettings('google.cloud.tasks.v2.CloudTasks', gapicConfig, opts.clientConfig || {}, {
  ...
  return _createClass(CloudTasksClient, [{
    ...
    value: function initialize() {
      ...
      this.cloudTasksStub = this._gaxGrpc.createStub(this._opts.fallback ? this._protos.lookupService('google.cloud.tasks.v2.CloudTasks') :
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      this._protos.google.cloud.tasks.v2.CloudTasks, this._opts, this._providedCustomServicePath);
    ...
    value: function close() {
      ...
      if (this.cloudTasksStub && !this._terminated) {
        return this.cloudTasksStub.then(function (stub) {
          ...
          stub.close();
          _this16.locationsClient.close()["catch"](function (err) {
            throw err;
          });
        });
      }
