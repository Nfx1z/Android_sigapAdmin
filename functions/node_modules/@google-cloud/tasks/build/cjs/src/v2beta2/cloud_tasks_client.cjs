...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // Copyright 2026 Google LLC
//
...
var CloudTasksClient = exports.CloudTasksClient = /*#__PURE__*/function () {
  ...
  return _createClass(CloudTasksClient, [{
    ...
    value: function getIamPolicy(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this0._log.info('getIamPolicy response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$g2 = this.innerApiCalls.getIamPolicy(request, options, wrappedCallback)) === null || _this$innerApiCalls$g2 === void 0 ? void 0 : _this$innerApiCalls$g2.then(function (_ref17) {
        ...
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos9 = _this0._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos9);
        }
        throw error;
      });
    }
    ...
    value: function setIamPolicy(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this1._log.info('setIamPolicy response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$s = this.innerApiCalls.setIamPolicy(request, options, wrappedCallback)) === null || _this$innerApiCalls$s === void 0 ? void 0 : _this$innerApiCalls$s.then(function (_ref19) {
        ...
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos0 = _this1._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos0);
        }
        throw error;
      });
    }
    ...
    value: function testIamPermissions(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this10._log.info('testIamPermissions response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$t = this.innerApiCalls.testIamPermissions(request, options, wrappedCallback)) === null || _this$innerApiCalls$t === void 0 ? void 0 : _this$innerApiCalls$t.then(function (_ref21) {
        ...
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos1 = _this10._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos1);
        }
        throw error;
      });
    }
    ...
    value: function getTask(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this11._log.info('getTask response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$g3 = this.innerApiCalls.getTask(request, options, wrappedCallback)) === null || _this$innerApiCalls$g3 === void 0 ? void 0 : _this$innerApiCalls$g3.then(function (_ref23) {
        ...
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos10 = _this11._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos10);
        }
        throw error;
      });
    }
    ...
    value: function createTask(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this12._log.info('createTask response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$c2 = this.innerApiCalls.createTask(request, options, wrappedCallback)) === null || _this$innerApiCalls$c2 === void 0 ? void 0 : _this$innerApiCalls$c2.then(function (_ref25) {
        ...
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos11 = _this12._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos11);
        }
        throw error;
      });
    }
    ...
    value: function deleteTask(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this13._log.info('deleteTask response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$d2 = this.innerApiCalls.deleteTask(request, options, wrappedCallback)) === null || _this$innerApiCalls$d2 === void 0 ? void 0 : _this$innerApiCalls$d2.then(function (_ref27) {
        ...
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos12 = _this13._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos12);
        }
        throw error;
      });
    }
    ...
    value: function leaseTasks(request, optionsOrCallback, callback) {
      ...
      this._log.info('leaseTasks request %j', request);
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this14._log.info('leaseTasks response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$l = this.innerApiCalls.leaseTasks(request, options, wrappedCallback)) === null || _this$innerApiCalls$l === void 0 ? void 0 : _this$innerApiCalls$l.then(function (_ref29) {
        var _ref30 = _slicedToArray(_ref29, 3),
          response = _ref30[0],
          options = _ref30[1],
          rawResponse = _ref30[2];
        _this14._log.info('leaseTasks response %j', response);
        return [response, options, rawResponse];
      })["catch"](function (error) {
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos13 = _this14._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos13);
        }
        throw error;
      });
    }
    ...
    value: function acknowledgeTask(request, optionsOrCallback, callback) {
      ...
      this._log.info('acknowledgeTask request %j', request);
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this15._log.info('acknowledgeTask response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$a = this.innerApiCalls.acknowledgeTask(request, options, wrappedCallback)) === null || _this$innerApiCalls$a === void 0 ? void 0 : _this$innerApiCalls$a.then(function (_ref31) {
        var _ref32 = _slicedToArray(_ref31, 3),
          response = _ref32[0],
          options = _ref32[1],
          rawResponse = _ref32[2];
        _this15._log.info('acknowledgeTask response %j', response);
        return [response, options, rawResponse];
      })["catch"](function (error) {
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos14 = _this15._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos14);
        }
        throw error;
      });
    }
    ...
    value: function renewLease(request, optionsOrCallback, callback) {
      ...
      this._log.info('renewLease request %j', request);
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this16._log.info('renewLease response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$r2 = this.innerApiCalls.renewLease(request, options, wrappedCallback)) === null || _this$innerApiCalls$r2 === void 0 ? void 0 : _this$innerApiCalls$r2.then(function (_ref33) {
        var _ref34 = _slicedToArray(_ref33, 3),
          response = _ref34[0],
          options = _ref34[1],
          rawResponse = _ref34[2];
        _this16._log.info('renewLease response %j', response);
        return [response, options, rawResponse];
      })["catch"](function (error) {
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos15 = _this16._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos15);
        }
        throw error;
      });
    }
    ...
    value: function cancelLease(request, optionsOrCallback, callback) {
      ...
      options.otherArgs.headers = options.otherArgs.headers || {};
      options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
        name: (_request$name0 = request.name) !== null && _request$name0 !== void 0 ? _request$name0 : ''
      });
      this.initialize()["catch"](function (err) {
        throw err;
      });
      this._log.info('cancelLease request %j', request);
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this17._log.info('cancelLease response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$c3 = this.innerApiCalls.cancelLease(request, options, wrappedCallback)) === null || _this$innerApiCalls$c3 === void 0 ? void 0 : _this$innerApiCalls$c3.then(function (_ref35) {
        var _ref36 = _slicedToArray(_ref35, 3),
          response = _ref36[0],
          options = _ref36[1],
          rawResponse = _ref36[2];
        _this17._log.info('cancelLease response %j', response);
        return [response, options, rawResponse];
      })["catch"](function (error) {
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos16 = _this17._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos16);
        }
        throw error;
      });
    }
    ...
    value: function runTask(request, optionsOrCallback, callback) {
      ...
      options.otherArgs.headers = options.otherArgs.headers || {};
      options.otherArgs.headers['x-goog-request-params'] = this._gaxModule.routingHeader.fromParams({
        name: (_request$name1 = request.name) !== null && _request$name1 !== void 0 ? _request$name1 : ''
      });
      this.initialize()["catch"](function (err) {
        throw err;
      });
      ...
      var wrappedCallback = callback ? function (error, response, options, rawResponse) {
        _this18._log.info('runTask response %j', response);
        callback(error, response, options, rawResponse);
      } : undefined;
      return (_this$innerApiCalls$r3 = this.innerApiCalls.runTask(request, options, wrappedCallback)) === null || _this$innerApiCalls$r3 === void 0 ? void 0 : _this$innerApiCalls$r3.then(function (_ref37) {
        var _ref38 = _slicedToArray(_ref37, 3),
          response = _ref38[0],
          options = _ref38[1],
          rawResponse = _ref38[2];
        _this18._log.info('runTask response %j', response);
        return [response, options, rawResponse];
      })["catch"](function (error) {
        if (error && 'statusDetails' in error && error.statusDetails instanceof Array) {
          var _protos17 = _this18._gaxModule.protobuf.Root.fromJSON(jsonProtos);
          error.statusDetails = (0, _googleGax.decodeAnyProtosInArray)(error.statusDetails, _protos17);
        }
        throw error;
      });
    }
    ...
    value: function listQueues(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, values, nextPageRequest, rawResponse) {
        _this19._log.info('listQueues values %j', values);
        callback(error, values, nextPageRequest, rawResponse);
      } : undefined;
      this._log.info('listQueues request %j', request);
      return (_this$innerApiCalls$l2 = this.innerApiCalls.listQueues(request, options, wrappedCallback)) === null || _this$innerApiCalls$l2 === void 0 ? void 0 : _this$innerApiCalls$l2.then(function (_ref39) {
        var _ref40 = _slicedToArray(_ref39, 3),
          response = _ref40[0],
          input = _ref40[1],
          output = _ref40[2];
        _this19._log.info('listQueues values %j', response);
    ...
    value: function listTasks(request, optionsOrCallback, callback) {
      ...
      var wrappedCallback = callback ? function (error, values, nextPageRequest, rawResponse) {
        _this20._log.info('listTasks values %j', values);
        callback(error, values, nextPageRequest, rawResponse);
      } : undefined;
      this._log.info('listTasks request %j', request);
      return (_this$innerApiCalls$l3 = this.innerApiCalls.listTasks(request, options, wrappedCallback)) === null || _this$innerApiCalls$l3 === void 0 ? void 0 : _this$innerApiCalls$l3.then(function (_ref41) {
        var _ref42 = _slicedToArray(_ref41, 3),
          response = _ref42[0],
          input = _ref42[1],
          output = _ref42[2];
        _this20._log.info('listTasks values %j', response);
        return [response, input, output];
      });
    }
    ...
    value: function close() {
      ...
      if (this.cloudTasksStub && !this._terminated) {
        return this.cloudTasksStub.then(function (stub) {
          _this21._log.info('ending gRPC channel');
          _this21._terminated = true;
          stub.close();
          _this21.locationsClient.close()["catch"](function (err) {
            throw err;
          });
        });
      }
