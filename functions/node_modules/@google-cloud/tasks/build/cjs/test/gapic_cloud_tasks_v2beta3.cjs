...
function getTypeDefaultValue(typeName, fields) {
  ...
  var _iterator9 = _createForOfIteratorHelper(fields.slice(0, -1)),
    _step9;
  try {
...
function stubLongRunningCall(response, callError, lroError) {
  var innerStub = lroError ? sinon.stub().rejects(lroError) : sinon.stub().resolves([response]);
  var mockOperation = {
    promise: innerStub
  };
...
(0, _mocha.describe)('v2beta3.CloudTasksClient', function () {
  ...
  (0, _mocha.describe)('updateCmekConfig', function () {
    (0, _mocha.it)('invokes updateCmekConfig without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee59() {
      var _request$cmekConfig;
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$updateC, _yield$client$updateC2, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context59) {
        while (1) switch (_context59.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest());
            (_request$cmekConfig = request.cmekConfig) !== null && _request$cmekConfig !== void 0 ? _request$cmekConfig : request.cmekConfig = {};
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest', ['cmekConfig', 'name']);
            request.cmekConfig.name = defaultValue1;
            expectedHeaderRequestParams = "cmek_config.name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.CmekConfig());
            client.innerApiCalls.updateCmekConfig = stubSimpleCall(expectedResponse);
            _context59.n = 2;
            return client.updateCmekConfig(request);
          case 2:
            _yield$client$updateC = _context59.v;
            _yield$client$updateC2 = _slicedToArray(_yield$client$updateC, 1);
            response = _yield$client$updateC2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.updateCmekConfig.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.updateCmekConfig.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 3:
    ...
    (0, _mocha.it)('invokes updateCmekConfig without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee60() {
      var _request$cmekConfig2;
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context60) {
        while (1) switch (_context60.n) {
          ...
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest());
            (_request$cmekConfig2 = request.cmekConfig) !== null && _request$cmekConfig2 !== void 0 ? _request$cmekConfig2 : request.cmekConfig = {};
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest', ['cmekConfig', 'name']);
            request.cmekConfig.name = defaultValue1;
            expectedHeaderRequestParams = "cmek_config.name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.CmekConfig());
            client.innerApiCalls.updateCmekConfig = stubSimpleCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.updateCmekConfig(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes updateCmekConfig with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee61() {
      var _request$cmekConfig3;
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context61) {
        while (1) switch (_context61.n) {
          ...
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest());
            (_request$cmekConfig3 = request.cmekConfig) !== null && _request$cmekConfig3 !== void 0 ? _request$cmekConfig3 : request.cmekConfig = {};
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest', ['cmekConfig', 'name']);
            request.cmekConfig.name = defaultValue1;
            expectedHeaderRequestParams = "cmek_config.name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.updateCmekConfig = stubSimpleCall(undefined, expectedError);
            _context61.n = 2;
            return _assert["default"].rejects(client.updateCmekConfig(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.updateCmekConfig.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.updateCmekConfig.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes updateCmekConfig with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee62() {
      var _request$cmekConfig4;
      var client, request, defaultValue1, expectedError;
      return _regenerator().w(function (_context62) {
        while (1) switch (_context62.n) {
          ...
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest());
            (_request$cmekConfig4 = request.cmekConfig) !== null && _request$cmekConfig4 !== void 0 ? _request$cmekConfig4 : request.cmekConfig = {};
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.UpdateCmekConfigRequest', ['cmekConfig', 'name']);
            request.cmekConfig.name = defaultValue1;
            expectedError = new Error('The client has already been closed.');
            client.close()["catch"](function (err) {
  ...
  (0, _mocha.describe)('getCmekConfig', function () {
    (0, _mocha.it)('invokes getCmekConfig without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee63() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$getCmek, _yield$client$getCmek2, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context63) {
        while (1) switch (_context63.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.GetCmekConfigRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.GetCmekConfigRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.CmekConfig());
            client.innerApiCalls.getCmekConfig = stubSimpleCall(expectedResponse);
            _context63.n = 2;
            return client.getCmekConfig(request);
          case 2:
            _yield$client$getCmek = _context63.v;
            _yield$client$getCmek2 = _slicedToArray(_yield$client$getCmek, 1);
            response = _yield$client$getCmek2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.getCmekConfig.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.getCmekConfig.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 3:
    ...
    (0, _mocha.it)('invokes getCmekConfig without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee64() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context64) {
        while (1) switch (_context64.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.CmekConfig());
            client.innerApiCalls.getCmekConfig = stubSimpleCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.getCmekConfig(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes getCmekConfig with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee65() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context65) {
        while (1) switch (_context65.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.getCmekConfig = stubSimpleCall(undefined, expectedError);
            _context65.n = 2;
            return _assert["default"].rejects(client.getCmekConfig(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.getCmekConfig.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.getCmekConfig.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes getCmekConfig with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee66() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('batchCreateTasks', function () {
    (0, _mocha.it)('invokes batchCreateTasks without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee67() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$batchCr, _yield$client$batchCr2, operation, _yield$operation$prom, _yield$operation$prom2, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context67) {
        while (1) switch (_context67.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.BatchCreateTasksRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.BatchCreateTasksRequest', ['parent']);
            request.parent = defaultValue1;
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.batchCreateTasks = stubLongRunningCall(expectedResponse);
            _context67.n = 2;
            return client.batchCreateTasks(request);
          case 2:
            _yield$client$batchCr = _context67.v;
            _yield$client$batchCr2 = _slicedToArray(_yield$client$batchCr, 1);
            operation = _yield$client$batchCr2[0];
            _context67.n = 3;
            return operation.promise();
          case 3:
            _yield$operation$prom = _context67.v;
            _yield$operation$prom2 = _slicedToArray(_yield$operation$prom, 1);
            response = _yield$operation$prom2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.batchCreateTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.batchCreateTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 4:
    ...
    (0, _mocha.it)('invokes batchCreateTasks without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee68() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, operation, _yield$operation$prom3, _yield$operation$prom4, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context68) {
        while (1) switch (_context68.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.batchCreateTasks = stubLongRunningCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.batchCreateTasks(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
            ...
            return promise;
          case 2:
            operation = _context68.v;
            _context68.n = 3;
            return operation.promise();
          case 3:
            _yield$operation$prom3 = _context68.v;
            _yield$operation$prom4 = _slicedToArray(_yield$operation$prom3, 1);
            response = _yield$operation$prom4[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.batchCreateTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.batchCreateTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes batchCreateTasks with call error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee69() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context69) {
        while (1) switch (_context69.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.batchCreateTasks = stubLongRunningCall(undefined, expectedError);
            _context69.n = 2;
            return _assert["default"].rejects(client.batchCreateTasks(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.batchCreateTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.batchCreateTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes batchCreateTasks with LRO error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee70() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, _yield$client$batchCr3, _yield$client$batchCr4, operation, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context70) {
        while (1) switch (_context70.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.batchCreateTasks = stubLongRunningCall(undefined, undefined, expectedError);
            _context70.n = 2;
            return client.batchCreateTasks(request);
          case 2:
            _yield$client$batchCr3 = _context70.v;
            _yield$client$batchCr4 = _slicedToArray(_yield$client$batchCr3, 1);
            operation = _yield$client$batchCr4[0];
            _context70.n = 3;
            return _assert["default"].rejects(operation.promise(), expectedError);
          case 3:
            actualRequest = client.innerApiCalls.batchCreateTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.batchCreateTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes checkBatchCreateTasksProgress without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee71() {
      var client, expectedResponse, decodedOperation;
      return _regenerator().w(function (_context71) {
        while (1) switch (_context71.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            expectedResponse = generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.Operation());
            ...
            _context71.n = 2;
            return client.checkBatchCreateTasksProgress(expectedResponse.name);
          case 2:
            decodedOperation = _context71.v;
            _assert["default"].deepStrictEqual(decodedOperation.name, expectedResponse.name);
            (0, _assert["default"])(decodedOperation.metadata);
            (0, _assert["default"])(client.operationsClient.getOperation.getCall(0));
          case 3:
            return _context71.a(2);
        }
      }, _callee71);
    })));
    (0, _mocha.it)('invokes checkBatchCreateTasksProgress with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee72() {
      var client, expectedError;
      return _regenerator().w(function (_context72) {
        while (1) switch (_context72.n) {
          ...
          case 1:
            ...
            _context72.n = 2;
            return _assert["default"].rejects(client.checkBatchCreateTasksProgress(''), expectedError);
          case 2:
            (0, _assert["default"])(client.operationsClient.getOperation.getCall(0));
          case 3:
  ...
  (0, _mocha.describe)('batchDeleteTasks', function () {
    (0, _mocha.it)('invokes batchDeleteTasks without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee73() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$batchDe, _yield$client$batchDe2, operation, _yield$operation$prom5, _yield$operation$prom6, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context73) {
        while (1) switch (_context73.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta3.BatchDeleteTasksRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta3.BatchDeleteTasksRequest', ['parent']);
            request.parent = defaultValue1;
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.batchDeleteTasks = stubLongRunningCall(expectedResponse);
            _context73.n = 2;
            return client.batchDeleteTasks(request);
          case 2:
            _yield$client$batchDe = _context73.v;
            _yield$client$batchDe2 = _slicedToArray(_yield$client$batchDe, 1);
            operation = _yield$client$batchDe2[0];
            _context73.n = 3;
            return operation.promise();
          case 3:
            _yield$operation$prom5 = _context73.v;
            _yield$operation$prom6 = _slicedToArray(_yield$operation$prom5, 1);
            response = _yield$operation$prom6[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.batchDeleteTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.batchDeleteTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 4:
    ...
    (0, _mocha.it)('invokes batchDeleteTasks without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee74() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, operation, _yield$operation$prom7, _yield$operation$prom8, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context74) {
        while (1) switch (_context74.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.batchDeleteTasks = stubLongRunningCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.batchDeleteTasks(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
            ...
            return promise;
          case 2:
            operation = _context74.v;
            _context74.n = 3;
            return operation.promise();
          case 3:
            _yield$operation$prom7 = _context74.v;
            _yield$operation$prom8 = _slicedToArray(_yield$operation$prom7, 1);
            response = _yield$operation$prom8[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.batchDeleteTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.batchDeleteTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes batchDeleteTasks with call error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee75() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context75) {
        while (1) switch (_context75.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.batchDeleteTasks = stubLongRunningCall(undefined, expectedError);
            _context75.n = 2;
            return _assert["default"].rejects(client.batchDeleteTasks(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.batchDeleteTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.batchDeleteTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes batchDeleteTasks with LRO error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee76() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, _yield$client$batchDe3, _yield$client$batchDe4, operation, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context76) {
        while (1) switch (_context76.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.batchDeleteTasks = stubLongRunningCall(undefined, undefined, expectedError);
            _context76.n = 2;
            return client.batchDeleteTasks(request);
          case 2:
            _yield$client$batchDe3 = _context76.v;
            _yield$client$batchDe4 = _slicedToArray(_yield$client$batchDe3, 1);
            operation = _yield$client$batchDe4[0];
            _context76.n = 3;
            return _assert["default"].rejects(operation.promise(), expectedError);
          case 3:
            actualRequest = client.innerApiCalls.batchDeleteTasks.getCall(0).args[0];
    ...
    (0, _mocha.it)('invokes checkBatchDeleteTasksProgress without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee77() {
      var client, expectedResponse, decodedOperation;
      return _regenerator().w(function (_context77) {
        while (1) switch (_context77.n) {
          ...
          case 1:
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            _context77.n = 2;
            return client.checkBatchDeleteTasksProgress(expectedResponse.name);
          case 2:
            decodedOperation = _context77.v;
            _assert["default"].deepStrictEqual(decodedOperation.name, expectedResponse.name);
            (0, _assert["default"])(decodedOperation.metadata);
            (0, _assert["default"])(client.operationsClient.getOperation.getCall(0));
          case 3:
    ...
    (0, _mocha.it)('invokes checkBatchDeleteTasksProgress with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee78() {
      var client, expectedError;
      return _regenerator().w(function (_context78) {
        while (1) switch (_context78.n) {
          ...
          case 1:
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            _context78.n = 2;
            return _assert["default"].rejects(client.checkBatchDeleteTasksProgress(''), expectedError);
          case 2:
            (0, _assert["default"])(client.operationsClient.getOperation.getCall(0));
          case 3:
  ...
  (0, _mocha.describe)('listQueues', function () {
    (0, _mocha.it)('invokes listQueues without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee79() {
      ...
      return _regenerator().w(function (_context79) {
        while (1) switch (_context79.n) {
          ...
          case 2:
            _yield$client$listQue = _context79.v;
    ...
    (0, _mocha.it)('invokes listQueues without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee80() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes listQueues with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee81() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes listQueuesStream without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee82() {
    ...
    (0, _mocha.it)('invokes listQueuesStream with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee83() {
    ...
    (0, _mocha.it)('uses async iteration with listQueues without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee84() {
      ...
      return _regenerator().w(function (_context84) {
        while (1) switch (_context84.p = _context84.n) {
          ...
          case 4:
            if (!(_iteratorAbruptCompletion = !(_step = _context84.v).done)) {
              _context84.n = 6;
              break;
            }
          ...
          case 11:
            return _context84.f(10);
          case 12:
            return _context84.f(8);
          case 13:
            _assert["default"].deepStrictEqual(responses, expectedResponse);
      ...
      }, _callee84, null, [[9,, 10, 12], [2, 7, 8, 13]]);
    })));
    (0, _mocha.it)('uses async iteration with listQueues with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee86() {
      ...
      return _regenerator().w(function (_context86) {
        while (1) switch (_context86.n) {
          ...
          case 1:
            ...
            iterable = client.listQueuesAsync(request);
            _context86.n = 2;
            return _assert["default"].rejects(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee85() {
              ...
              return _regenerator().w(function (_context85) {
                while (1) switch (_context85.p = _context85.n) {
                  ...
                  case 3:
                    if (!(_iteratorAbruptCompletion2 = !(_step2 = _context85.v).done)) {
                      _context85.n = 5;
                      break;
                    }
                  ...
                  case 10:
                    return _context85.f(9);
                  case 11:
                    return _context85.f(7);
                  case 12:
                    return _context85.a(2);
                }
              }, _callee85, null, [[8,, 9, 11], [1, 6, 7, 12]]);
            })));
          case 2:
            _assert["default"].deepStrictEqual(client.descriptors.page.listQueues.asyncIterate.getCall(0).args[1], request);
            (0, _assert["default"])(client.descriptors.page.listQueues.asyncIterate.getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
  ...
  (0, _mocha.describe)('listTasks', function () {
    (0, _mocha.it)('invokes listTasks without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee87() {
      ...
      return _regenerator().w(function (_context87) {
        while (1) switch (_context87.n) {
          ...
          case 2:
            _yield$client$listTas = _context87.v;
    ...
    (0, _mocha.it)('invokes listTasks without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee88() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes listTasks with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee89() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes listTasksStream without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee90() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, stream, promise, responses;
    ...
    (0, _mocha.it)('invokes listTasksStream with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee91() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, stream, promise;
    ...
    (0, _mocha.it)('uses async iteration with listTasks without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee92() {
      ...
      return _regenerator().w(function (_context92) {
        while (1) switch (_context92.p = _context92.n) {
          ...
          case 4:
            if (!(_iteratorAbruptCompletion3 = !(_step3 = _context92.v).done)) {
              _context92.n = 6;
              break;
            }
          ...
          case 11:
            return _context92.f(10);
          case 12:
            return _context92.f(8);
          case 13:
            _assert["default"].deepStrictEqual(responses, expectedResponse);
      ...
      }, _callee92, null, [[9,, 10, 12], [2, 7, 8, 13]]);
    })));
    (0, _mocha.it)('uses async iteration with listTasks with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee94() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, iterable;
      return _regenerator().w(function (_context94) {
        while (1) switch (_context94.n) {
          ...
          case 1:
            ...
            iterable = client.listTasksAsync(request);
            _context94.n = 2;
            return _assert["default"].rejects(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee93() {
              ...
              return _regenerator().w(function (_context93) {
                while (1) switch (_context93.p = _context93.n) {
                  ...
                  case 3:
                    if (!(_iteratorAbruptCompletion4 = !(_step4 = _context93.v).done)) {
                      _context93.n = 5;
                      break;
                    }
                  ...
                  case 10:
                    return _context93.f(9);
                  case 11:
                    return _context93.f(7);
                  case 12:
                    return _context93.a(2);
                }
              }, _callee93, null, [[8,, 9, 11], [1, 6, 7, 12]]);
            })));
          case 2:
            _assert["default"].deepStrictEqual(client.descriptors.page.listTasks.asyncIterate.getCall(0).args[1], request);
            (0, _assert["default"])(client.descriptors.page.listTasks.asyncIterate.getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
  ...
  (0, _mocha.describe)('getLocation', function () {
    (0, _mocha.it)('invokes getLocation without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee95() {
    ...
    (0, _mocha.it)('invokes getLocation without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee96() {
    ...
    (0, _mocha.it)('invokes getLocation with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee97() {
  ...
  (0, _mocha.describe)('listLocationsAsync', function () {
    (0, _mocha.it)('uses async iteration with listLocations without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee98() {
      ...
      return _regenerator().w(function (_context98) {
        while (1) switch (_context98.p = _context98.n) {
          ...
          case 4:
            if (!(_iteratorAbruptCompletion5 = !(_step5 = _context98.v).done)) {
              _context98.n = 6;
              break;
            }
          ...
          case 11:
            return _context98.f(10);
          case 12:
            return _context98.f(8);
          case 13:
            _assert["default"].deepStrictEqual(responses, expectedResponse);
      ...
      }, _callee98, null, [[9,, 10, 12], [2, 7, 8, 13]]);
    })));
    (0, _mocha.it)('uses async iteration with listLocations with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee100() {
      ...
      return _regenerator().w(function (_context100) {
        while (1) switch (_context100.n) {
          ...
          case 1:
            ...
            iterable = client.listLocationsAsync(request);
            _context100.n = 2;
            return _assert["default"].rejects(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee99() {
              ...
              return _regenerator().w(function (_context99) {
                while (1) switch (_context99.p = _context99.n) {
                  ...
                  case 3:
                    if (!(_iteratorAbruptCompletion6 = !(_step6 = _context99.v).done)) {
                      _context99.n = 5;
                      break;
                    }
                  ...
                  case 10:
                    return _context99.f(9);
                  case 11:
                    return _context99.f(7);
                  case 12:
                    return _context99.a(2);
                }
              }, _callee99, null, [[8,, 9, 11], [1, 6, 7, 12]]);
            })));
          case 2:
            _assert["default"].deepStrictEqual(client.locationsClient.descriptors.page.listLocations.asyncIterate.getCall(0).args[1], request);
            (0, _assert["default"])(client.locationsClient.descriptors.page.listLocations.asyncIterate.getCall(0).args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
  ...
  (0, _mocha.describe)('getOperation', function () {
    (0, _mocha.it)('invokes getOperation without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee101() {
      var client, request, expectedResponse, response;
      return _regenerator().w(function (_context101) {
        while (1) switch (_context101.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.GetOperationRequest());
            expectedResponse = generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.Operation());
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            _context101.n = 2;
            return client.getOperation(request);
          case 2:
            response = _context101.v;
            _assert["default"].deepStrictEqual(response, [expectedResponse]);
            (0, _assert["default"])(client.operationsClient.getOperation.getCall(0).calledWith(request));
          case 3:
            return _context101.a(2);
        }
      }, _callee101);
    })));
    (0, _mocha.it)('invokes getOperation without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee102() {
      ...
      return _regenerator().w(function (_context102) {
        while (1) switch (_context102.n) {
          case 0:
            ...
            promise = new Promise(function (resolve, reject) {
              client.operationsClient.getOperation(request, undefined, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes getOperation with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee104() {
      ...
      return _regenerator().w(function (_context104) {
        while (1) switch (_context104.n) {
          case 0:
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            _context104.n = 1;
            return _assert["default"].rejects(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee103() {
  ...
  (0, _mocha.describe)('cancelOperation', function () {
    (0, _mocha.it)('invokes cancelOperation without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee105() {
      var client, request, expectedResponse, response;
      return _regenerator().w(function (_context105) {
        while (1) switch (_context105.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.CancelOperationRequest());
            expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.operationsClient.cancelOperation = stubSimpleCall(expectedResponse);
            _context105.n = 2;
            return client.cancelOperation(request);
          case 2:
            response = _context105.v;
            _assert["default"].deepStrictEqual(response, [expectedResponse]);
            (0, _assert["default"])(client.operationsClient.cancelOperation.getCall(0).calledWith(request));
          case 3:
            return _context105.a(2);
        }
      }, _callee105);
    })));
    (0, _mocha.it)('invokes cancelOperation without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee106() {
      var client, request, expectedResponse, promise, response;
      return _regenerator().w(function (_context106) {
        while (1) switch (_context106.n) {
          case 0:
            ...
            promise = new Promise(function (resolve, reject) {
              client.operationsClient.cancelOperation(request, undefined, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
          ...
          case 1:
            ...
            _assert["default"].deepStrictEqual(response, expectedResponse);
            (0, _assert["default"])(client.operationsClient.cancelOperation.getCall(0));
          case 2:
            return _context106.a(2);
        }
      }, _callee106);
    })));
    (0, _mocha.it)('invokes cancelOperation with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee108() {
      var client, request, expectedError;
      return _regenerator().w(function (_context108) {
        while (1) switch (_context108.n) {
          case 0:
            ...
            _context108.n = 1;
            return _assert["default"].rejects(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee107() {
  ...
  (0, _mocha.describe)('deleteOperation', function () {
    (0, _mocha.it)('invokes deleteOperation without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee109() {
      var client, request, expectedResponse, response;
      return _regenerator().w(function (_context109) {
        while (1) switch (_context109.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.DeleteOperationRequest());
            expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.operationsClient.deleteOperation = stubSimpleCall(expectedResponse);
            _context109.n = 2;
            return client.deleteOperation(request);
          case 2:
            response = _context109.v;
            _assert["default"].deepStrictEqual(response, [expectedResponse]);
            (0, _assert["default"])(client.operationsClient.deleteOperation.getCall(0).calledWith(request));
          case 3:
            return _context109.a(2);
        }
      }, _callee109);
    })));
    (0, _mocha.it)('invokes deleteOperation without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee110() {
      var client, request, expectedResponse, promise, response;
      return _regenerator().w(function (_context110) {
        while (1) switch (_context110.n) {
          case 0:
            ...
            promise = new Promise(function (resolve, reject) {
              client.operationsClient.deleteOperation(request, undefined, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
            ...
            return promise;
          case 1:
            response = _context110.v;
            _assert["default"].deepStrictEqual(response, expectedResponse);
            (0, _assert["default"])(client.operationsClient.deleteOperation.getCall(0));
          case 2:
            return _context110.a(2);
        }
      }, _callee110);
    })));
    (0, _mocha.it)('invokes deleteOperation with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee112() {
      var client, request, expectedError;
      return _regenerator().w(function (_context112) {
        while (1) switch (_context112.n) {
          case 0:
            ...
            _context112.n = 1;
            return _assert["default"].rejects(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee111() {
  ...
  (0, _mocha.describe)('listOperationsAsync', function () {
    (0, _mocha.it)('uses async iteration with listOperations without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee113() {
      var client, request, expectedResponse, responses, iterable, _iteratorAbruptCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, resource, _t7;
      return _regenerator().w(function (_context113) {
        while (1) switch (_context113.p = _context113.n) {
          case 0:
            ...
            request = generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.ListOperationsRequest());
            expectedResponse = [generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.ListOperationsResponse()), generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.ListOperationsResponse()), generateSampleMessage(new _googleGax.operationsProtos.google.longrunning.ListOperationsResponse())];
            client.operationsClient.descriptor.listOperations.asyncIterate = stubAsyncIterationCall(expectedResponse);
            responses = [];
            iterable = client.operationsClient.listOperationsAsync(request);
          ...
          case 3:
            if (!(_iteratorAbruptCompletion7 = !(_step7 = _context113.v).done)) {
              _context113.n = 5;
              break;
            }
            resource = _step7.value;
            responses.push(resource);
          case 4:
            _iteratorAbruptCompletion7 = false;
            _context113.n = 2;
          ...
          case 10:
            return _context113.f(9);
          case 11:
            return _context113.f(7);
          case 12:
            _assert["default"].deepStrictEqual(responses, expectedResponse);
            _assert["default"].deepStrictEqual(client.operationsClient.descriptor.listOperations.asyncIterate.getCall(0).args[1], request);
          case 13:
            return _context113.a(2);
        }
      }, _callee113, null, [[8,, 9, 11], [1, 6, 7, 12]]);
    })));
    (0, _mocha.it)('uses async iteration with listOperations with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee115() {
      var client, request, expectedError, iterable;
      return _regenerator().w(function (_context115) {
        while (1) switch (_context115.n) {
          ...
          case 1:
            ...
            iterable = client.operationsClient.listOperationsAsync(request);
            _context115.n = 2;
            return _assert["default"].rejects(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee114() {
              var responses, _iteratorAbruptCompletion8, _didIteratorError8, _iteratorError8, _iterator8, _step8, resource, _t8;
              return _regenerator().w(function (_context114) {
                while (1) switch (_context114.p = _context114.n) {
                  case 0:
                    ...
                    _context114.p = 1;
                    _iterator8 = _asyncIterator(iterable);
                  case 2:
                    _context114.n = 3;
                    return _iterator8.next();
                  case 3:
                    if (!(_iteratorAbruptCompletion8 = !(_step8 = _context114.v).done)) {
                      _context114.n = 5;
                      break;
                    }
                    resource = _step8.value;
                    responses.push(resource);
                  case 4:
                    _iteratorAbruptCompletion8 = false;
                    _context114.n = 2;
                  ...
                  case 10:
                    return _context114.f(9);
                  case 11:
                    return _context114.f(7);
                  case 12:
                    return _context114.a(2);
                }
              }, _callee114, null, [[8,, 9, 11], [1, 6, 7, 12]]);
            })));
          case 2:
            _assert["default"].deepStrictEqual(client.operationsClient.descriptor.listOperations.asyncIterate.getCall(0).args[1], request);
          case 3:
  ...
  (0, _mocha.describe)('Path templates', function () {
    (0, _mocha.describe)('cmekConfig', function () {
      var fakePath = '/rendered/path/cmekConfig';
      ...
      client.pathTemplates.cmekConfigPathTemplate.render = sinon.stub().returns(fakePath);
      client.pathTemplates.cmekConfigPathTemplate.match = sinon.stub().returns(expectedParameters);
      (0, _mocha.it)('cmekConfigPath', function () {
        var result = client.cmekConfigPath('projectValue', 'locationValue');
        _assert["default"].strictEqual(result, fakePath);
        (0, _assert["default"])(client.pathTemplates.cmekConfigPathTemplate.render.getCall(-1).calledWith(expectedParameters));
      });
      (0, _mocha.it)('matchProjectFromCmekConfigName', function () {
        var result = client.matchProjectFromCmekConfigName(fakePath);
        _assert["default"].strictEqual(result, 'projectValue');
        (0, _assert["default"])(client.pathTemplates.cmekConfigPathTemplate.match.getCall(-1).calledWith(fakePath));
      });
      (0, _mocha.it)('matchLocationFromCmekConfigName', function () {
        var result = client.matchLocationFromCmekConfigName(fakePath);
