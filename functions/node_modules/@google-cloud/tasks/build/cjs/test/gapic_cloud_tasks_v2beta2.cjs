...
(0, _mocha.describe)('v2beta2.CloudTasksClient', function () {
  (0, _mocha.describe)('Common methods', function () {
    (0, _mocha.it)('has apiEndpoint', function () {
      var client = new cloudtasksModule.v2beta2.CloudTasksClient();
    ...
    if ((typeof process === "undefined" ? "undefined" : _typeof(process)) === 'object' && typeof process.emitWarning === 'function') {
      (0, _mocha.it)('throws DeprecationWarning if static servicePath is used', function () {
        ...
        var servicePath = cloudtasksModule.v2beta2.CloudTasksClient.servicePath;
      ...
      (0, _mocha.it)('throws DeprecationWarning if static apiEndpoint is used', function () {
        var stub = sinon.stub(process, 'emitWarning');
        var apiEndpoint = cloudtasksModule.v2beta2.CloudTasksClient.apiEndpoint;
        _assert["default"].strictEqual(apiEndpoint, 'cloudtasks.googleapis.com');
        (0, _assert["default"])(stub.called);
        stub.restore();
      });
    ...
    (0, _mocha.it)('has port', function () {
      var port = cloudtasksModule.v2beta2.CloudTasksClient.port;
    ...
    (0, _mocha.it)('has initialize method and supports deferred initialization', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            client = new cloudtasksModule.v2beta2.CloudTasksClient({
              credentials: {
                client_email: 'bogus',
                private_key: 'bogus'
              },
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.GetQueueRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.GetQueueRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
      ...
      return _regenerator().w(function (_context9) {
        while (1) switch (_context9.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.CreateQueueRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.CreateQueueRequest', ['parent']);
      ...
      return _regenerator().w(function (_context11) {
        while (1) switch (_context11.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.UpdateQueueRequest());
            (_request$queue = request.queue) !== null && _request$queue !== void 0 ? _request$queue : request.queue = {};
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.UpdateQueueRequest', ['queue', 'name']);
      ...
      return _regenerator().w(function (_context15) {
        while (1) switch (_context15.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.DeleteQueueRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.DeleteQueueRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
      ...
      return _regenerator().w(function (_context19) {
        while (1) switch (_context19.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.PurgeQueueRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.PurgeQueueRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
      ...
      return _regenerator().w(function (_context23) {
        while (1) switch (_context23.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.PauseQueueRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.PauseQueueRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
      ...
      return _regenerator().w(function (_context27) {
        while (1) switch (_context27.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.ResumeQueueRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.ResumeQueueRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue());
  ...
  (0, _mocha.describe)('uploadQueueYaml', function () {
    (0, _mocha.it)('invokes uploadQueueYaml without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee31() {
      var client, request, expectedResponse, _yield$client$uploadQ, _yield$client$uploadQ2, response;
      return _regenerator().w(function (_context31) {
        while (1) switch (_context31.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.UploadQueueYamlRequest());
            expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.uploadQueueYaml = stubSimpleCall(expectedResponse);
            _context31.n = 2;
            return client.uploadQueueYaml(request);
          case 2:
            _yield$client$uploadQ = _context31.v;
            _yield$client$uploadQ2 = _slicedToArray(_yield$client$uploadQ, 1);
            response = _yield$client$uploadQ2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
          case 3:
    ...
    (0, _mocha.it)('invokes uploadQueueYaml without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee32() {
      ...
      return _regenerator().w(function (_context32) {
        while (1) switch (_context32.n) {
          ...
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.UploadQueueYamlRequest());
            expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.uploadQueueYaml = stubSimpleCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.uploadQueueYaml(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes uploadQueueYaml with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee33() {
      ...
      return _regenerator().w(function (_context33) {
        while (1) switch (_context33.n) {
          ...
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.UploadQueueYamlRequest());
            expectedError = new Error('expected');
            client.innerApiCalls.uploadQueueYaml = stubSimpleCall(undefined, expectedError);
            _context33.n = 2;
            return _assert["default"].rejects(client.uploadQueueYaml(request), expectedError);
          case 2:
            return _context33.a(2);
        }
      }, _callee33);
    })));
    (0, _mocha.it)('invokes uploadQueueYaml with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee34() {
      var client, request, expectedError;
  ...
  (0, _mocha.describe)('getIamPolicy', function () {
    (0, _mocha.it)('invokes getIamPolicy without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee35() {
      ...
      return _regenerator().w(function (_context35) {
        while (1) switch (_context35.n) {
          ...
          case 2:
            _yield$client$getIamP = _context35.v;
    ...
    (0, _mocha.it)('invokes getIamPolicy without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee36() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes getIamPolicy with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee37() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes getIamPolicy with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee38() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('setIamPolicy', function () {
    (0, _mocha.it)('invokes setIamPolicy without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee39() {
      ...
      return _regenerator().w(function (_context39) {
        while (1) switch (_context39.n) {
          ...
          case 2:
            _yield$client$setIamP = _context39.v;
    ...
    (0, _mocha.it)('invokes setIamPolicy without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee40() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes setIamPolicy with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee41() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes setIamPolicy with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee42() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('testIamPermissions', function () {
    (0, _mocha.it)('invokes testIamPermissions without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee43() {
      ...
      return _regenerator().w(function (_context43) {
        while (1) switch (_context43.n) {
          ...
          case 2:
            _yield$client$testIam = _context43.v;
    ...
    (0, _mocha.it)('invokes testIamPermissions without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee44() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes testIamPermissions with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee45() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes testIamPermissions with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee46() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('getTask', function () {
    (0, _mocha.it)('invokes getTask without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee47() {
      ...
      return _regenerator().w(function (_context47) {
        while (1) switch (_context47.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.GetTaskRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.GetTaskRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
            client.innerApiCalls.getTask = stubSimpleCall(expectedResponse);
            _context47.n = 2;
            return client.getTask(request);
          case 2:
            _yield$client$getTask = _context47.v;
    ...
    (0, _mocha.it)('invokes getTask without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee48() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes getTask with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee49() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes getTask with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee50() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('createTask', function () {
    (0, _mocha.it)('invokes createTask without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee51() {
      ...
      return _regenerator().w(function (_context51) {
        while (1) switch (_context51.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.CreateTaskRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.CreateTaskRequest', ['parent']);
            request.parent = defaultValue1;
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
          ...
          case 2:
            _yield$client$createT = _context51.v;
    ...
    (0, _mocha.it)('invokes createTask without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee52() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes createTask with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee53() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes createTask with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee54() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('deleteTask', function () {
    (0, _mocha.it)('invokes deleteTask without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee55() {
      ...
      return _regenerator().w(function (_context55) {
        while (1) switch (_context55.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.DeleteTaskRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.DeleteTaskRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
          ...
          case 2:
            _yield$client$deleteT = _context55.v;
    ...
    (0, _mocha.it)('invokes deleteTask without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee56() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes deleteTask with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee57() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes deleteTask with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee58() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('leaseTasks', function () {
    (0, _mocha.it)('invokes leaseTasks without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee59() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$leaseTa, _yield$client$leaseTa2, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context59) {
        while (1) switch (_context59.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.LeaseTasksRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.LeaseTasksRequest', ['parent']);
            request.parent = defaultValue1;
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.LeaseTasksResponse());
            client.innerApiCalls.leaseTasks = stubSimpleCall(expectedResponse);
            _context59.n = 2;
            return client.leaseTasks(request);
          case 2:
            _yield$client$leaseTa = _context59.v;
            _yield$client$leaseTa2 = _slicedToArray(_yield$client$leaseTa, 1);
            response = _yield$client$leaseTa2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.leaseTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.leaseTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 3:
    ...
    (0, _mocha.it)('invokes leaseTasks without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee60() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context60) {
        while (1) switch (_context60.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.LeaseTasksResponse());
            client.innerApiCalls.leaseTasks = stubSimpleCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.leaseTasks(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes leaseTasks with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee61() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context61) {
        while (1) switch (_context61.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.leaseTasks = stubSimpleCall(undefined, expectedError);
            _context61.n = 2;
            return _assert["default"].rejects(client.leaseTasks(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.leaseTasks.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.leaseTasks.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes leaseTasks with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee62() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('acknowledgeTask', function () {
    (0, _mocha.it)('invokes acknowledgeTask without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee63() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$acknowl, _yield$client$acknowl2, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context63) {
        while (1) switch (_context63.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.AcknowledgeTaskRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.AcknowledgeTaskRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.acknowledgeTask = stubSimpleCall(expectedResponse);
            _context63.n = 2;
            return client.acknowledgeTask(request);
          case 2:
            _yield$client$acknowl = _context63.v;
            _yield$client$acknowl2 = _slicedToArray(_yield$client$acknowl, 1);
            response = _yield$client$acknowl2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.acknowledgeTask.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.acknowledgeTask.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 3:
    ...
    (0, _mocha.it)('invokes acknowledgeTask without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee64() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context64) {
        while (1) switch (_context64.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            client.innerApiCalls.acknowledgeTask = stubSimpleCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.acknowledgeTask(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes acknowledgeTask with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee65() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context65) {
        while (1) switch (_context65.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.acknowledgeTask = stubSimpleCall(undefined, expectedError);
            _context65.n = 2;
            return _assert["default"].rejects(client.acknowledgeTask(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.acknowledgeTask.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.acknowledgeTask.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes acknowledgeTask with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee66() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('renewLease', function () {
    (0, _mocha.it)('invokes renewLease without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee67() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$renewLe, _yield$client$renewLe2, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context67) {
        while (1) switch (_context67.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.RenewLeaseRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.RenewLeaseRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
            client.innerApiCalls.renewLease = stubSimpleCall(expectedResponse);
            _context67.n = 2;
            return client.renewLease(request);
          case 2:
            _yield$client$renewLe = _context67.v;
            _yield$client$renewLe2 = _slicedToArray(_yield$client$renewLe, 1);
            response = _yield$client$renewLe2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.renewLease.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.renewLease.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 3:
    ...
    (0, _mocha.it)('invokes renewLease without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee68() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context68) {
        while (1) switch (_context68.n) {
          ...
          case 1:
            ...
            promise = new Promise(function (resolve, reject) {
              client.renewLease(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes renewLease with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee69() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context69) {
        while (1) switch (_context69.n) {
          ...
          case 1:
            ...
            _context69.n = 2;
            return _assert["default"].rejects(client.renewLease(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.renewLease.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.renewLease.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes renewLease with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee70() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('cancelLease', function () {
    (0, _mocha.it)('invokes cancelLease without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee71() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, _yield$client$cancelL, _yield$client$cancelL2, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context71) {
        while (1) switch (_context71.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.CancelLeaseRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.CancelLeaseRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
            client.innerApiCalls.cancelLease = stubSimpleCall(expectedResponse);
            _context71.n = 2;
            return client.cancelLease(request);
          case 2:
            _yield$client$cancelL = _context71.v;
            _yield$client$cancelL2 = _slicedToArray(_yield$client$cancelL, 1);
            response = _yield$client$cancelL2[0];
            _assert["default"].deepStrictEqual(response, expectedResponse);
            actualRequest = client.innerApiCalls.cancelLease.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.cancelLease.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            (0, _assert["default"])(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
          case 3:
    ...
    (0, _mocha.it)('invokes cancelLease without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee72() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context72) {
        while (1) switch (_context72.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
            client.innerApiCalls.cancelLease = stubSimpleCallWithCallback(expectedResponse);
            promise = new Promise(function (resolve, reject) {
              client.cancelLease(request, function (err, result) {
                if (err) {
                  reject(err);
                } else {
                  resolve(result);
    ...
    (0, _mocha.it)('invokes cancelLease with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee73() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
      return _regenerator().w(function (_context73) {
        while (1) switch (_context73.n) {
          ...
          case 1:
            ...
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedError = new Error('expected');
            client.innerApiCalls.cancelLease = stubSimpleCall(undefined, expectedError);
            _context73.n = 2;
            return _assert["default"].rejects(client.cancelLease(request), expectedError);
          case 2:
            actualRequest = client.innerApiCalls.cancelLease.getCall(0).args[0];
            _assert["default"].deepStrictEqual(actualRequest, request);
            actualHeaderRequestParams = client.innerApiCalls.cancelLease.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
    ...
    (0, _mocha.it)('invokes cancelLease with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee74() {
      var client, request, defaultValue1, expectedError;
  ...
  (0, _mocha.describe)('runTask', function () {
    (0, _mocha.it)('invokes runTask without error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee75() {
      ...
      return _regenerator().w(function (_context75) {
        while (1) switch (_context75.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.RunTaskRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.RunTaskRequest', ['name']);
            request.name = defaultValue1;
            expectedHeaderRequestParams = "name=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task());
          ...
          case 2:
            _yield$client$runTask = _context75.v;
    ...
    (0, _mocha.it)('invokes runTask without error using callback', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee76() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedResponse, promise, response, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes runTask with error', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee77() {
      var client, request, defaultValue1, expectedHeaderRequestParams, expectedError, actualRequest, actualHeaderRequestParams;
    ...
    (0, _mocha.it)('invokes runTask with closed client', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee78() {
      var client, request, defaultValue1, expectedError;
      ...
      return _regenerator().w(function (_context79) {
        while (1) switch (_context79.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.ListQueuesRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.ListQueuesRequest', ['parent']);
            request.parent = defaultValue1;
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = [generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue()), generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue()), generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Queue())];
      ...
      return _regenerator().w(function (_context87) {
        while (1) switch (_context87.n) {
          case 0:
            ...
            return client.initialize();
          case 1:
            request = generateSampleMessage(new protos.google.cloud.tasks.v2beta2.ListTasksRequest());
            defaultValue1 = getTypeDefaultValue('.google.cloud.tasks.v2beta2.ListTasksRequest', ['parent']);
            request.parent = defaultValue1;
            expectedHeaderRequestParams = "parent=".concat(defaultValue1 !== null && defaultValue1 !== void 0 ? defaultValue1 : '');
            expectedResponse = [generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task()), generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task()), generateSampleMessage(new protos.google.cloud.tasks.v2beta2.Task())];
